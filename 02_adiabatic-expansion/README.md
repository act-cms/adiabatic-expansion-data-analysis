...
1. Use data slicing to find relevant information in an array.
2. Extract relevant text from a text-based file.
3. Compute heat capacities using experimental and computational techniques.
...
* [Lab Handout](https://github.com/act-cms/adiabatic-expansion-data-analysis/tree/main/02_adiabatic-expansion/adiabatic_handout.md)
